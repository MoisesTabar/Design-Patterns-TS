...
*/
var realUser = /** @class */ (function () {
    function realUser() {
    }
    realUser.prototype.request = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.api)];
                    case 1:
                        url = _a.sent();
 ...
 * proxies.
 */
var clientCode = function (user) {
    user.request();
};
//client executing the code with a real user
var newUser = new realUser();
...
var newProxy = new proxy(newUser);
clientCode(newProxy);
